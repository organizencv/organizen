...
export function TaskChecklist({ taskId, task, checkItems, onUpdate, language }: TaskChecklistProps) {
      ...
      <div className="space-y-2">
        ...
        {isTaskCompleted && (
          <p className="text-xs text-muted-foreground text-right">
            {language === 'pt' 
              ? 'Não é possível modificar checklist numa tarefa concluída' 
              : 'Cannot modify checklist in a completed task'}
          </p>
        )}
      </div>
