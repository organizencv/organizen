...
import { Plus, Search, Building2, Edit, Trash2, Users, Eye } from 'lucide-react';
...
export function DepartmentsContent({ departments: initialDepartments, userRole, templates }: DepartmentsContentProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <PageHeader title={getTranslation('departments', language)}>
      ...
      {isDetailsModalOpen && viewingDepartmentId && (
