...
export default function TeamsPage() {
  ...
  const [selectedSubTeamId, setSelectedSubTeamId] = useState('none');
  ...
  const handleAddMember = async () => {
    if (!selectedTeam || !selectedUserId || selectedUserId === 'none') return;
  ...
  const handleOpenLinkSubTeamDialog = (parentTeam: Team) => {
    setParentTeamForSubTeam(parentTeam);
    setSelectedSubTeamId('none');
    setIsLinkSubTeamDialogOpen(true);
  };

  const handleLinkSubTeam = async () => {
    if (!parentTeamForSubTeam || !selectedSubTeamId || selectedSubTeamId === 'none') return;
      ...
      <Dialog open={isAddMemberDialogOpen} onOpenChange={setIsAddMemberDialogOpen}>
        <DialogContent className="w-[95vw] max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select value={selectedUserId} onValueChange={setSelectedUserId}>
                ...
                <SelectContent>
                  <SelectItem value="none">Selecione um utilizador</SelectItem>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddMember} disabled={!selectedUserId || selectedUserId === 'none'}>
              Adicionar
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isLinkSubTeamDialogOpen} onOpenChange={setIsLinkSubTeamDialogOpen}>
        <DialogContent className="w-[95vw] max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select value={selectedSubTeamId} onValueChange={setSelectedSubTeamId}>
                ...
                <SelectContent>
                  <SelectItem value="none">Selecione uma equipa</SelectItem>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleLinkSubTeam} disabled={!selectedSubTeamId || selectedSubTeamId === 'none'}>
              Vincular Sub-equipa
            </Button>
          </DialogFooter>
        </DialogContent>
